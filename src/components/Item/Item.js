                ...
                <div className="contenedor-btn-detail">
                    
                    {
                        isInCar(item.id)
                            ...
                            :  <button onClick={ handleAgregar } disabled className="text-white bg-[#24292F]  focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2">
                            Agregar
                            </button>
                    }
                </div>
